...
#== MultiPlugin クラス
class RustASP3Plugin < MultiPlugin
    def self.get_plugin superClass
      ...
      if superClass == SignaturePlugin then
        ...
        require_tecsgen_lib "tecslib/plugin/RustASP3CelltypePlugin.rb"
        return RustASP3CelltypePlugin
      elsif superClass == CellPlugin then
        require_tecsgen_lib "tecslib/plugin/RustASP3CellPlugin.rb"
        return RustASP3CellPlugin
