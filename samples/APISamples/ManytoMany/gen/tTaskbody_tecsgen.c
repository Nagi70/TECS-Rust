...
extern struct tag_sSensor_VDES SensorA_eSensor_des;

extern struct tag_sSensor_VDES SensorB_eSensor_des;
...
tTaskbody_INIB tTaskbody_INIB_tab[] = {
    ...
    {
        /* call port (INIB) #_CP_# */ 
        &SensorA_eSensor_des,                    /* cSensor #_CCP1_# */
        /* entry port #_EP_# */ 
    },
    /* cell: tTaskbody_CB_tab[1]:  Taskbody2 id=2 */
    {
        /* call port (INIB) #_CP_# */ 
        &SensorB_eSensor_des,                    /* cSensor #_CCP1_# */
        /* entry port #_EP_# */ 
    },
};
