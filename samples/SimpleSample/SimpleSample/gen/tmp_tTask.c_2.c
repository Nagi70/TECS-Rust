...
# 58 "./gen/tmp_tTask.c" 2
# 1 "./gen/tTask_tecsgen.h" 1
# 21 "./gen/tTask_tecsgen.h"
# 1 "./gen/global_tecsgen.h" 1
# 10 "./gen/global_tecsgen.h"
...
# 10 "../../../test/cygwin/cygwin_tecs.h" 2
# 1 "/usr/include/memory.h" 1 3 4
# 11 "../../../test/cygwin/cygwin_tecs.h" 2
...
# 1 "/home/yosshy/tecsgen-V1.9.0-Beta5/tecsgen/tecsgen/tecs/tecs.h" 1
# 46 "/home/yosshy/tecsgen-V1.9.0-Beta5/tecsgen/tecsgen/tecs/tecs.h"
...
# 11 "./gen/global_tecsgen.h" 2
# 22 "./gen/tTask_tecsgen.h" 2


# 1 "./gen/sTask_tecsgen.h" 1
# 17 "./gen/sTask_tecsgen.h"
...
typedef struct { struct tag_sTask_VDES *vdes; } DynDesc__sTask;
# 25 "./gen/tTask_tecsgen.h" 2
# 1 "./gen/sTaskBody_tecsgen.h" 1
# 17 "./gen/sTaskBody_tecsgen.h"
...
typedef struct { struct tag_sTaskBody_VDES *vdes; } DynDesc__sTaskBody;
# 26 "./gen/tTask_tecsgen.h" 2
# 1 "./gen/sTaskExceptionBody_tecsgen.h" 1
# 17 "./gen/sTaskExceptionBody_tecsgen.h"
...
typedef struct { struct tag_sTaskExceptionBody_VDES *vdes; } DynDesc__sTaskExceptionBody;
# 27 "./gen/tTask_tecsgen.h" 2
...
typedef const struct tag_tTask_INIB {
    ...
    struct tag_sTaskExceptionBody_VDES const*cExceptionBody;
...
static inline ER tTask_eTask_activate(tTask_IDX idx);
static inline ER tTask_eTask_suspend(tTask_IDX idx);
static inline ER tTask_eTask_resume(tTask_IDX idx);
# 141 "./gen/tTask_tecsgen.h"
...
# 211 "./gen/tTask_tecsgen.h"
# 1 "../../../test/cygwin/tTask_inline.h" 1
# 37 "../../../test/cygwin/tTask_inline.h"
static inline ER
tTask_eTask_activate(tTask_IDX idx)
{
 ER ercd = 0;
 tTask_CB *p_cellcb;
 if ((1)) {
...
static inline ER
tTask_eTask_suspend(tTask_IDX idx)
{
 ER ercd = 0;
 tTask_CB *p_cellcb;
 if ((1)) {
 ...
 pthread_mutex_lock( &((p_cellcb)->my_mutex) );
 if( pthread_cond_wait( &((p_cellcb)->my_cond), &((p_cellcb)->my_mutex) ) != 0 )
  ercd = (-28);
 pthread_mutex_unlock( &((p_cellcb)->my_mutex) );
...
static inline ER
tTask_eTask_resume(tTask_IDX idx)
{
 ER ercd = 0;
 tTask_CB *p_cellcb;
 if ((1)) {
 ...
 if( pthread_cond_signal( &((p_cellcb)->my_cond) ) != 0 )
  ercd = (-28);

 return(ercd);
}
# 212 "./gen/tTask_tecsgen.h" 2
# 59 "./gen/tmp_tTask.c" 2
...
{
 tTask_CB *p_cellcb = (tTask_CB *)p;

 ((p_cellcb)->state) = ((const int)1);

 pthread_mutex_init ( &((p_cellcb)->my_mutex), 0 );
 pthread_cond_init ( &((p_cellcb)->my_cond), 0 );



 pthread_mutex_lock( &((p_cellcb)->my_mutex) );
 pthread_cond_wait( &((p_cellcb)->my_cond), &((p_cellcb)->my_mutex) );
 pthread_mutex_unlock( &((p_cellcb)->my_mutex) ) ;

 fprintf( 
# 94 "./gen/tmp_tTask.c" 3 4
         stderr
# 94 "./gen/tmp_tTask.c"
               , "*** starting task '%s'  %08lX\n", ((p_cellcb)->_inib->name), (unsigned long)tTask_call_cBody_main );
 (p_cellcb)->cBody.main__T( );
 fprintf( 
# 96 "./gen/tmp_tTask.c" 3 4
         stderr
# 96 "./gen/tmp_tTask.c"
               , "*** exiting task '%s'\n", ((p_cellcb)->_inib->name) );
 pthread_exit(0);
...
int main(int arg, char **argv)
{
 ...
 state = 1;
 for( (i) = 0; (i) < (1); (i)++ ){ (p_cellcb) = &tTask_CB_tab[i];
  if( n_pthread >= 100 ){
   fprintf( 
# 127 "./gen/tmp_tTask.c" 3 4
           stderr
# 127 "./gen/tmp_tTask.c"
                 , "too many threads max=%d", 100 );
   exit( 1 );
  }
  pthread_create( &((p_cellcb)->my_thread), 
# 130 "./gen/tmp_tTask.c" 3 4
                                 ((void *)0)
# 130 "./gen/tmp_tTask.c"
                                     , tTask_call_cBody_main, (void *)p_cellcb );
  pthread[n_pthread] = ((p_cellcb)->my_thread);
  n_pthread++;
 }
 ...
 for( (i) = 0; (i) < (1); (i)++ ){ (p_cellcb) = &tTask_CB_tab[i];
  ...
  while( ((p_cellcb)->state) != ((const int)1) )
 ...
 for( (i) = 0; (i) < (1); (i)++ ){ (p_cellcb) = &tTask_CB_tab[i];
  if( ((p_cellcb)->_inib->taskAttribute) & (0x02U) ){

   pthread_cond_signal( &((p_cellcb)->my_cond) );
   state++;
  }
 }
...
prepare_signal()
{
 int result;
    ...
    sigemptyset(&set);
    sigaddset(&set, 
# 186 "./gen/tmp_tTask.c" 3 4
                   13
# 186 "./gen/tmp_tTask.c"
                          );
    s = pthread_sigmask(
# 187 "./gen/tmp_tTask.c" 3 4
                       0
# 187 "./gen/tmp_tTask.c"
                                , &set, 
# 187 "./gen/tmp_tTask.c" 3 4
...
# 187 "./gen/tmp_tTask.c"
    ...
    if (s != 0)
        do { 
# 189 "./gen/tmp_tTask.c" 3 4
       (*__errno_location ()) 
# 189 "./gen/tmp_tTask.c"
       = s; perror("pthread_sigmask"); exit(
# 189 "./gen/tmp_tTask.c" 3 4
       1
# 189 "./gen/tmp_tTask.c"
       ); } while (0);
...
# 192 "./gen/tmp_tTask.c" 3 4
                               ((void *)0)
# 192 "./gen/tmp_tTask.c"
                                   , &sig_thread, (void *) &set);
    if (s != 0)
        do { 
# 194 "./gen/tmp_tTask.c" 3 4
       (*__errno_location ()) 
# 194 "./gen/tmp_tTask.c"
       = s; perror("pthread_create"); exit(
# 194 "./gen/tmp_tTask.c" 3 4
       1
# 194 "./gen/tmp_tTask.c"
       ); } while (0);
...
sig_thread(void *arg)
{
    ...
    for (;;) {
        ...
        if (s != 0)
            do { 
# 209 "./gen/tmp_tTask.c" 3 4
           (*__errno_location ()) 
# 209 "./gen/tmp_tTask.c"
           = s; perror("sigwait"); exit(
# 209 "./gen/tmp_tTask.c" 3 4
           1
# 209 "./gen/tmp_tTask.c"
           ); } while (0);
