...
# 0 "<command-line>" 2
# 1 "./gen/tmp_tSample.c"
# 18 "./gen/tmp_tSample.c"
typedef char *__builtin_va_list;
# 33 "./gen/tmp_tSample.c"
\U0000feff
...
# 42 "./gen/tmp_tSample.c" 2
# 1 "./gen/tSample_tecsgen.h" 1
# 21 "./gen/tSample_tecsgen.h"
...
# 22 "./gen/tSample_tecsgen.h" 2


# 1 "./gen/sSample_tecsgen.h" 1
# 17 "./gen/sSample_tecsgen.h"
...
typedef struct { struct tag_sSample_VDES *vdes; } DynDesc__sSample;
# 25 "./gen/tSample_tecsgen.h" 2
...
# 43 "./gen/tmp_tSample.c" 2
# 62 "./gen/tmp_tSample.c"
ER
tSample_eEnt_sayHello(tSample_IDX idx, int32_t times)
{
 ER ercd = 0;
 tSample_CB *p_cellcb;
 if ((1)) {
...
ER
tSample_eEnt_howAreYou(tSample_IDX idx, char_t* buf, int32_t len)
{
 ER ercd = 0;
 tSample_CB *p_cellcb;
 if ((1)) {
