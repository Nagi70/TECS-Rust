...
use crate::tecs_signature::{s_periodic_reactorbody::*, s_pubsub::*};

use crate::tecs_celltype::{t_imu::*, t_pubsub::*};

pub struct TPeriodicReactor<'a, T, U>
where
...
pub struct LockGuardForTPeriodicReactor<'a, T, U>
where
	T: SPeriodicReactorbody,
	U: SPubsub,
{
...
#[link_section = ".rodata"]
static PERIODICREACTOR: TPeriodicReactor<EImuForTImu, EPubsubForTPubsub> = TPeriodicReactor {
