...
impl SMeasurement for EMeasureForTMeasurement{
	...
	fn twist_measurement_matrix(&self) -> nalgebra::Matrix2x6<f64> {
	...
	fn twist_measurement_covariance(&self, covariance: &nalgebra::Matrix6<f64>, smoothing_step: &u32) -> nalgebra::Matrix2<f64> {
