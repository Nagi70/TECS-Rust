...
use core::num::NonZeroI32;
use crate::kernel_cfg::*;
use crate::{s_reactorbody::*, t_imu_corrector::*, s_pubsub::*, t_pubsub::*};

pub struct TReactor<'a, T, U, V>where
	T: SReactorbody,
	U: SPubsub,
	V: SPubsub,
{
...
pub struct LockGuardForTReactor<'a, T, U, V>where
	T: SReactorbody,
	U: SPubsub,
	V: SPubsub,
{
...
#[link_section = ".rodata"]
pub static REACTOR: TReactor<EImuCorrectorForTImuCorrector, EPubsubForTPubsub, EPubsubForTPubsub> = TReactor {
...
pub static REACTORVAR: SyncTReactorVar = SyncTReactorVar {
...
#[link_section = ".rodata"]
pub static REACTOR_EX_CTRL_REF: TECSMutexRef = TECSMutexRef{
