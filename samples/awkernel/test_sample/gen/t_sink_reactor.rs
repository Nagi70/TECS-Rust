...
use core::num::NonZeroI32;
use crate::kernel_cfg::*;
use crate::{s_sink_reactorbody::*, t_gyro_odometer::*, s_pubsub::*, t_pubsub::*};

pub struct TSinkReactor<'a, T, U>where
	T: SSinkReactorbody,
	U: SPubsub,
{
	c_taskbody: &'a T,
...
pub struct LockGuardForTSinkReactor<'a, T, U>where
	T: SSinkReactorbody,
	U: SPubsub,
{
	pub c_taskbody: &'a T,
...
#[link_section = ".rodata"]
pub static SINKREACTOR: TSinkReactor<EGyroOdometerForTGyroOdometer, EPubsubForTPubsub> = TSinkReactor {
...
pub static SINKREACTORVAR: SyncTSinkReactorVar = SyncTSinkReactorVar {
...
#[link_section = ".rodata"]
pub static SINKREACTOR_EX_CTRL_REF: TECSMutexRef = TECSMutexRef{
